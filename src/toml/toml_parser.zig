...
pub const TOML = struct {
    ...
    pub fn parseKeySegment(p: *TOML) anyerror!?Expr {
        ...
        switch (p.lexer.token) {
            ...
            .t_identifier => {
                const str = E.String2.init(p.lexer.identifier);
                try p.lexer.next();
                return p.e(str, loc);
            },
            .t_false => {
            ...
            .t_numeric_literal => {
                ...
                try p.lexer.next();
                return p.e(E.String2.init(literal), loc);
            },
    ...
    pub fn parseValue(p: *TOML) anyerror!Expr {
        ...
        switch (p.lexer.token) {
            ...
            .t_identifier => {
                const str: E.String2 = E.String2.init(p.lexer.identifier);
